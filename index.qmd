---
title: "Programa de Prevención y Control de Arbovirosis | 2026 | Yucatán"
format: 
  dashboard:
...
```{r distribucion_merida,echo=FALSE}
z |>
...
```{r distribucion_valla,echo=FALSE}
z |>
    dplyr::filter(IDE_EDA_ANO <= 12 | IDE_EDA_ANO >= 65) |>
    dplyr::mutate(onset = FEC_INI_SIGNOS_SINT) |>
    dplyr::select(ANO, long, lat, onset) |>
...
::: grid-card
```{r heatmap_valladolid,echo=FALSE}
z |>
    dplyr::filter(IDE_EDA_ANO <= 12 | IDE_EDA_ANO >= 65) |>
    dplyr::mutate(onset = FEC_INI_SIGNOS_SINT) |>
    dplyr::select(ANO, long, lat, onset) |>
